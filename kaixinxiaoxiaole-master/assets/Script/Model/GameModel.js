...
export default class GameModel {
    ...
    checkPoint(x, y) {
        ...
        //result: x,y轴方向上紧邻可消的同类型物体集合
        //记录改物体的状态 消5个 出现超级块   横向大于4 line  纵向大于4 column  消三个 普通wrap
        //this.cells[y][x].type 该物体类型
